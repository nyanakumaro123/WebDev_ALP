        ...
        <div class="flex flex-col items-center">
            ...
            <div class="flex flex-row-reverse justify-center group">
                @for ($i = 5; $i >= 1; $i--)
                   ...
                   {{-- Ganti sxtar menjadi star --}}
                  <label for="star{{ $i }}" class="cursor-pointer text-gray-300 hover:text-yellow-400 peer-checked:text-yellow-500 transition-colors duration-200">
