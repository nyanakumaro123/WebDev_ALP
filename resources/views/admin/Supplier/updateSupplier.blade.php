                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input 
                            ...
                            required 
                            class="block w-full px-4 py-3 border @error('SupplierName') border-red-500 @else border-gray-300 @enderror rounded-lg shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-base transition duration-150"
                        >
                        @error('SupplierName')
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input 
                            ...
                            required 
                            class="block w-full px-4 py-3 border @error('CompanyName') border-red-500 @else border-gray-300 @enderror rounded-lg shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-base transition duration-150"
                        >
                        @error('CompanyName')
                            <p class="mt-1 text-xs text-red-500 font-medium">{{ $message }}</p>
                        @enderror
