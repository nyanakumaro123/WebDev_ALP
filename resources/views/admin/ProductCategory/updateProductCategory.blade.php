                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('update.product.category') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="ProductCategoryName" type="text" class="form-control @error('ProductCategoryName') is-invalid @enderror" name="ProductCategoryName" value="{{ old('ProductCategoryName', $productCategory->ProductCategoryName) }}" required autocomplete="ProductCategoryName" autofocus>
