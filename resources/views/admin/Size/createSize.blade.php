    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('size.create') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="SizeValue" type="text" class="form-control @error('SizeValue') is-invalid @enderror" name="SizeValue" value="{{ old('SizeValue') }}" required autocomplete="SizeValue" autofocus>
