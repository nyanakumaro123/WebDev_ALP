            ...
            <div class="w-full md:w-8/12">
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="px-6 py-4 bg-gray-100 border-b border-gray-200">
                        <h4 class="text-lg font-semibold text-gray-800">{{ ('Edit Size') }}</h4>
                    </div>
                    ...
                    <div class="p-6">
                        <form method="POST" action="{{ route('sizes.update', $size->id) }}">
                            ...
                            <div class="mb-6">
                                ...
                                <div>
                                    <input id="SizeValue" 
                                           ...
                                           name="SizeValue" 
                                           value="{{ old('SizeValue', $size->SizeValue) }}" 
                                           required 
                            ...
                            <!-- Size Category -->
                            <div class="mb-6">
                                <label for="SizeCategoryID" class="block text-sm font-medium text-gray-700 mb-2">
                                    {{ ('Size Category') }}
                                </label>
                                <div>
