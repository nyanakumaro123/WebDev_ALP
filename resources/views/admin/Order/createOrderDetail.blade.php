                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        <div>
                            ...
                            <select name="ProductID" id="product_id" class="w-full border-2 border-gray-200 rounded-lg p-3 focus:border-indigo-500 outline-none transition" required>
                        ...
                        <div>
                            ...
                            <select name="ColorID" class="w-full border-2 border-gray-200 rounded-lg p-3 outline-none focus:border-indigo-500" required>
                        ...
                        <div>
                            ...
                            <select name="SizeID" class="w-full border-2 border-gray-200 rounded-lg p-3 outline-none focus:border-indigo-500" required>
                    ...
                    <div class="bg-gray-50 p-6 rounded-xl border border-gray-200 space-y-4">
                        <div>
                            ...
                            <input type="number" name="OrderQuantity" id="order_quantity" min="1" value="1" 
                                class="w-full border-2 border-gray-200 rounded-lg p-3 outline-none focus:border-indigo-500" required>
                        ...
                        <div class="pt-4">
                            ...
                            <div class="text-4xl font-bold text-indigo-700 mt-1">
